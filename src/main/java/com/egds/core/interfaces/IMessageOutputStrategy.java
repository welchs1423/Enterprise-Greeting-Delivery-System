 ...
 * Implementations determine how and where a finalized
 * {@link MessageEntity} is rendered, enabling runtime substitution of
 * delivery channels without pipeline modification.
 */
public interface IMessageOutputStrategy {

    /**
     * Executes the delivery of the supplied message entity to the
     ...
     *         if the output channel is unavailable or entity cannot render
     */
